...
class TutorCourse(models.Model):
    ...
    duration_minutes = models.IntegerField()  # in minutes
    course_type = models.CharField(max_length=10, choices=[('online', 'Online'), ('offline', 'Offline')])
    price_per_hour = models.DecimalField(max_digits=10, decimal_places=2)
    lesson_package = models.CharField(max_length=100)  # e.g., "1-hour lessons", "10-lesson package"
    language = models.CharField(max_length=50)
    days_available = models.JSONField(default=list, blank=True)  # e.g., ['mon', 'tue', 'wed']
